...
<template>
    <nav
        class="bg-gradient-to-r from-purple-600 via-blue-500 to-teal-400 border-b border-teal-300 shadow-lg"
    >
            ...
            <div class="flex h-20 items-center justify-between">
                ...
                <div class="flex items-center">
                    <RouterLink class="flex items-center group" to="/">
                        <img
                            class="h-12 w-auto rounded-full bg-green-200 p-1 shadow-md transition-transform duration-300 group-hover:scale-110"
                            :src="logo"
                            alt="Car Rental"
                        />
                        <span
                            class="ml-3 text-green-200 text-2xl font-bold tracking-tight drop-shadow-md transition-all duration-300 group-hover:text-white"
                            >Tailwind Cars</span
                        >
                    </RouterLink>
                </div>
                ...
                <div class="hidden md:flex md:items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <div
                            ...
                            class="flex items-center border-l border-white border-opacity-20 pl-4 ml-4"
                        >
                            ...
                            <span
                                class="ml-2 mr-4 text-white text-sm font-medium"
                ...
                <div class="flex md:hidden">
                    <button
                        @click="toggleMenu"
                        type="button"
                        class="text-white hover:bg-indigo-500 p-2 rounded-md transition-colors"
                    >
                        <svg
                            class="h-6 w-6"
                            fill="none"
        ...
        <div v-if="isOpen" class="md:hidden">
            <div
                class="space-y-1 px-2 pb-3 pt-2 bg-gradient-to-b from-purple-600 to-blue-500"
            >
                <RouterLink
                    to="/"
                    @click="toggleMenu"
                ...
                <RouterLink
                    ...
                    @click="toggleMenu"
                    :class="[
                        isActiveLink('/profile') || isActiveLink('/client')
                ...
                <div
                    v-if="isLoggedIn && userData"
                    class="mt-4 border-t border-blue-400 pt-3"
                >
