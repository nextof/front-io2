<template>
    <form
        ...
        class="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 space-y-6"
    >
        <div>
            ...
            <input
                ...
                required
            />
            <p v-if="errorUsername" class="text-red-600 text-sm mt-1">
                {{ errorUsername }}
            </p>
        </div>
        ...
        <div>
            ...
            <input
                ...
                required
            />
            <p v-if="errorEmail" class="text-red-600 text-sm mt-1">
                {{ errorEmail }}
            </p>
        </div>
        ...
        <div>
            ...
            <input
                ...
                required
            />
            <p v-if="errorPassword" class="text-red-600 text-sm mt-1">
                {{ errorPassword }}
            </p>
        </div>
