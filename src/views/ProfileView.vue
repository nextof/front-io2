<template>
    <section class="max-w-3xl mx-auto mt-8">
        ...
        >
            <div
                class="bg-white rounded-lg shadow-xl max-w-sm w-full p-8 relative"
            >
                <button
                    @click="closeModal"
                    class="absolute right-3 top-3 text-gray-400 hover:text-gray-700 text-xl"
                >
                    &times;
                </button>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="py-2 px-3">
                                ...
                                >
                                <span
                                    v-else-if="reservation.status === 'MANUAL'"
                                    class="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs font-semibold"
                                    >Manual</span
                                >
                                <span
